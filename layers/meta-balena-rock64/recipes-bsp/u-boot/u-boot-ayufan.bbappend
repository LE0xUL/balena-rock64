...
SRC_URI_append = " \
	file://1001-Add-Resin-specific-boot-command.patch \
	file://1002-rock64-board-Enable-CONFIG_CMD_SETEXPR.patch \
	file://1003-resin-specific-env-integration-kconfig.patch \
"
